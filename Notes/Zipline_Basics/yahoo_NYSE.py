...
def yahoo_NYSE(tframes=None, csvdir=None):
    """
    ...
    return Yahoo_NYSEBundle(tframes, csvdir).ingest


class Yahoo_NYSEBundle:
    """
...
@bundles.register("yahoo_NYSE")
def yahoo_NYSE_bundle(
    environ,
    asset_db_writer,
    minute_bar_writer,
    daily_bar_writer,
    ...
    for tframe in tframes:
        ...
        writer.write(
            _pricing_iter(ddir, symbols, metadata,sessions, divs_splits, show_progress),
